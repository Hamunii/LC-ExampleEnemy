...
print(color.lightblue + f'Part 1 of 2 complete!{color.purple}\n> Next you will have to provide a path to where we will copy your mod files each time your build it.\n'
      ...
      '     r2modman: /home/user/.config/r2modmanPlus-local/LethalCompany/profiles/testing\n'
      '     Game installation: /home/user/.local/share/Steam/steamapps/common/Lethal Company')
...
if not (userInputPath[-1] == "/" or userInputPath[-1] == '\\'):
...
<Project ToolsVersion="Current" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
   ...
   <PropertyGroup>
      <TestProfileDir>{userInputPath}</TestProfileDir>
   </PropertyGroup>

   <Target Name="CopyToTestProfile" DependsOnTargets="NetcodePatch" AfterTargets="PostBuildEvent">
      <MakeDir
         Directories="$(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/"
         Condition="!Exists('$(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/')"
      />
      <Exec Command="{copyCommand} &quot;$(TargetPath)&quot; &quot;$(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/&quot;" />
      <Exec Command="{copyCommand} &quot;../UnityProject/AssetBundles/StandaloneWindows/modassets&quot; &quot;$(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/&quot;" />
      <Exec Command="echo '[csproj.user] Mod files copied to $(TestProfileDir)BepInEx/plugins/$(AssemblyName)-DEV/'" />
   </Target>
</Project>"""
